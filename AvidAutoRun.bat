...
CLS
ECHO Welcome to Avid Auto Restart and Update
ECHO --------------------------------------------
...
bitsadmin.exe /transfer "Downloading Avid (Latest)" /priority high https://github.com/Kwoth/NadekoBot/raw/master/scripts/Latest.bat "%FILENAME%"
